...
namespace CircularQuesues_CSharp
{
    class Queues
    {
        ...
        public Queues()
        {
             ...
             * to indicate that the queue is initiallu empty.*/
            FRONT = -1;
            REAR = -1;
        }
        public void insert(int element)
        {
            ...
            /* The folowing statement checks whether hte queue is empty. if the
             * queue is
             * empty, then the value of the REAR and FRONT variables is set to
             * 0.*/
            if (FRONT == -1)
            {
                FRONT = 0;
        ...
        public void display()
        {
            ...
            {
                /* traverse the queue till the last element present in an arry.*/
